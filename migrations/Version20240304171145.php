 ...
 */
final class Version20240304171145 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE challenge_activite (challenge_id INT NOT NULL, activite_id INT NOT NULL, INDEX IDX_254BB2F598A21AC6 (challenge_id), INDEX IDX_254BB2F59B0F88B1 (activite_id), PRIMARY KEY(challenge_id, activite_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`');
        ...
        $this->addSql('ALTER TABLE publication ADD rating INT NOT NULL, ADD somme INT NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE challenge_activité (challenge_id INT NOT NULL, activité_id INT NOT NULL, INDEX IDX_48A7A28FED02027C (activité_id), INDEX IDX_48A7A28F98A21AC6 (challenge_id), PRIMARY KEY(challenge_id, activité_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
        ...
        $this->addSql('ALTER TABLE publication DROP rating, DROP somme');
        $this->addSql('ALTER TABLE user CHANGE role role LONGTEXT NOT NULL COMMENT \'(DC2Type:array)\', CHANGE reservation_id reservation_id INT NOT NULL');
    }
}
