...
class ActiviteController extends AbstractController
{
    ...
    #[Route('/activites', name: 'app_activite_indexfront', methods: ['GET'])]
    public function indexfront(ActiviteRepository $activiteRepository): Response
    {
        return $this->render('activite/indexfront.html.twig', [
            'activit' => $activiteRepository->findAll(),
        ]);
    }
