...
class ReservationController extends AbstractController
{
   ...
   /* #[Route('/{id}', name: 'app_reservation_delete', methods: ['POST'])]
    ...
    #[Route('/app_reservation_delete/{id}', name: 'app_reservation_delete')]
    public function app_reservation_delete($id,ReservationRepository $reservationRepository, ManagerRegistry $managerRegistry, Request $req): Response
    {
        $emm = $managerRegistry->getManager();
        $idremove = $reservationRepository->find($id);
        $emm->remove($idremove);
        $emm->flush();
