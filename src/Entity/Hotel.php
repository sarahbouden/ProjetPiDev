...
class Hotel
{
    ...
    #[Assert\Regex(
        pattern:"/^[A-Za-z]+$/", 
        message:"Write the location in words please"
    )]
    ...
    #[Assert\Regex(
        pattern:"/^[A-Za-z]+$/", 
        message:"Write an understandable description please"
    )]
    ...
    {
        return $this->getId(); // Retourne le nom de l'hôtel (ou toute autre représentation significative)
    }
