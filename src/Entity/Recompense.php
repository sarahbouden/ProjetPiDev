...
class Recompense
{
    ...
    #[Assert\NotBlank(message: "Veuillez saisir le nom de la récompense.")]
    #[ORM\Column(length: 255)]
    private ?string $NomRecp = null;

    #[Assert\NotBlank(message: "Veuillez saisir le niveau.")]
    #[ORM\Column(length: 255)]
    private ?string $Niveau = null;

    #[Assert\NotBlank(message: "Veuillez saisir la description de la récompense.")]
    #[ORM\Column(length: 255)]
